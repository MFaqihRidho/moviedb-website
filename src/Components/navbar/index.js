        ...
        <nav className="w-full h-20 antialiased text-white shadow bg-one">
            <div className="container flex items-center justify-between h-full px-6 mx-auto lg:px-0">
                ...
                <div className="relative order-3">
                    ...
                    <input
                        type="text"
                        className="z-0 px-2 w-3/4 sm:w-full py-2 bg-gray-500 rounded-lg shadow md:px-10 focus:outline-none focus:ring focus:ring-sky-900/60"
                        placeholder="Search Movie"
                        onChange={(e) => changeHandle(e)}
                        value={data}
                    />
                    <div class="absolute top-1.5 right-20 md:right-3">
                        <button
                            onClick={search}
                            id="search"
